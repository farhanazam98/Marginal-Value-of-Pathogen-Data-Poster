...
\begin{columns}
  ...
  \block{6. Discussion/Policy Relevance}{%
    ...
    \begin{itemize}
      \item This experiment isolates the effect of increased data on mutation effect prediction, and shows an (albeit small) improvement in performance, using the most publicly accessible data available. More specific, curated, and experimentally validated data could lead to more substantial increases in dual use capabilities. 
