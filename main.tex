...
\begin{columns}
  ...
  \block{6. Discussion/Policy Relevance}{%
    ...
    \begin{itemize}
      ...
      \item More empirical assessment of the following capabilities would be valuable:  transmissibility prediction, virulence prediction, antigen + antibody affinity prediction, structure and inverse folding prediction. 
    \end{itemize}
  }
