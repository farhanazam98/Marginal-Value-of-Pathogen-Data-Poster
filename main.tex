...
\settitle{
  ...
  \begin{minipage}[c]{0.70\linewidth}\centering
    ...
    \vspace*{0.7em}
    % Byline: presenter on line 1, mentor on line 2. Comma between a person
    % and their affiliation reads more consistently than a bullet.
    {\color{titlefgcolor}\Large \@author, \@institute \par}
    \vspace*{0.25em}
