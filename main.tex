...
\begin{columns}
  ...
  \block{3. Methodology: The Pipeline}{%
    ...
    \begin{tikzfigure}
      \includegraphics[width=0.48\linewidth]{figures/protein-varient-scoring.png}
    \end{tikzfigure}
    \vspace{0.4em}
    \begin{itemize}
