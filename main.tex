...
%---------------------------------------------------------------------
%  Enlarge figure captions. tikzposter hardcodes \small in the
%  tikzfigure environment, which is unreadable at A0 viewing distance.
%  Redefinition below is identical to the class except the caption is
%  set at \large instead of \small.
%---------------------------------------------------------------------
\makeatletter
\renewenvironment{tikzfigure}[1][]{%
  ...
  \ifx\rememberparameter\@empty\else
    \\[10pt]{\large Fig.~\thefigurecounter: \rememberparameter}%
  \fi
  \end{center}%
}
\makeatother
