...
\begin{columns}
  ...
  \block{1. Background \& Motivation}{%
    ...
    \end{itemize}
    \vspace{0.5em}
    \begin{tikzfigure}[We’ve seen an explosion of biological data in recent years. However, it’s unclear whether additional data has improved model performance, specifically on tasks related to viral protein design capabilities.]
...
\begin{columns}
  ...
  \block{4. Preliminary Results }{%
    ...
    \begin{tikzfigure}[{Additional protein sequence data does not seem to reliably increase mutation effect prediction on SARS-CoV-2 proteins. For fitness of SARS-CoV-2 main protease, performance increases marginally. For binding and expressio of spike (S) protein of SARS-CoV-2 spike protein, additional data hinders performance.}]
