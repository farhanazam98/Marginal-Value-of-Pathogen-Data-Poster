...
\begin{columns}
  ...
  \block{1. Background \& Motivation}{%
    ...
    \begin{itemize}
      \item \PN{why pathogen-data controls, and the empirical gap}
      \item \PN{}
      \item \PN{}
    \end{itemize}
    \vspace{0.5em}
  ...
  \block{2. Research Question}{%
    ...
    \PN{the one-line research question}
    \vspace{0.6em}
    \begin{itemize}
      \item \textbf{Protein sequence data:} \PN{}
      \item \textbf{Alignment models:} \PN{}
      \item \textbf{Mutation-effect prediction:} \PN{}
    \end{itemize}
  }
  ...
  \block{3. Methodology: The Pipeline}{%
    ...
    \vspace{0.4em}
    \begin{itemize}
      \item \PN{snapshots, proteins, depth/relatedness control}
      \item \PN{}
    \end{itemize}
  }
